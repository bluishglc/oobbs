...
import oobbs.domainmodel.LabelValue;
 ...
 * @version $Revision: 1.5 $ $Date: 2010/03/23 09:19:54 $
 */
public class CountryTag extends TagSupport {
    ...
    public int doStartTag() throws JspException {
        ...
        /*
         * Tag's scope is used to mark the life cycle of tag's data model.
         * Here, we will put CountryTag's data model: countries to specified scope! 
         */
        if (scope != null) {
