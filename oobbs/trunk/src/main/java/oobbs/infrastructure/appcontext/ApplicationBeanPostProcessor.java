...
public class ApplicationBeanPostProcessor implements BeanPostProcessor,ApplicationContextAware {
	...
	public Object postProcessAfterInitialization(Object bean, String beanName)	throws BeansException {
		...
		// Registers DomainTaskPerformer for DomainObjectSupport.
		if("domainObjectSupport".equals(beanName)){
			DomainObjectSupport domainObjectSupport = (DomainObjectSupport) bean;
			DomainSupportRequestProcessor forumRepository = (DomainSupportRequestProcessor) applicationContext.getBean("forumRepository");
			domainObjectSupport.registerDomainSupportRequestProcessor(SupportRequest.COUNT_FORUM_POSTS,forumRepository );
			domainObjectSupport.registerDomainSupportRequestProcessor(SupportRequest.GET_FORUM_LATEST_POST, forumRepository);
		}
		return bean;
	}
