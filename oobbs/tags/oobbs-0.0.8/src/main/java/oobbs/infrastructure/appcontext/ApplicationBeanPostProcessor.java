...
public class ApplicationBeanPostProcessor implements BeanPostProcessor,ApplicationContextAware {
	...
	public Object postProcessAfterInitialization(Object bean, String beanName)	throws BeansException {
		...
		if("domainObjectSupport".equals(beanName)){
			...
			DomainActionPerformer forumRepository = (DomainActionPerformer) applicationContext.getBean("forumRepository");
			domainObjectSupport.registerDomainActionPerformer(DomainAction.COUNT_FORUM_POSTS,forumRepository );
			domainObjectSupport.registerDomainActionPerformer(DomainAction.GET_FORUM_LATEST_POST, forumRepository);
		}
