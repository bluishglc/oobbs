package oobbs.application.service.impl;

import oobbs.application.service.user.BaseManagerMockTestCase;

public class UserServiceImplTest extends BaseManagerMockTestCase {
//    //~ Instance fields ========================================================
//    private UserServiceImpl userManager = new UserServiceImpl();
//    private RoleManagerImpl roleManager = new RoleManagerImpl();
//    private UserRepository userDao = null;
//    private RoleRepository roleDao = null;
//
//    //~ Methods ================================================================
//    @Before
//    public void setUp() throws Exception {
//        userDao = context.mock(UserRepository.class);
//        userManager.setUserDao(userDao);
//        roleDao = context.mock(RoleRepository.class);
